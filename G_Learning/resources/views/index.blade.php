        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="#"><img src="{{asset('/')}}images/logo/gLearning.jpeg" alt="Logo" style="height: 45px; width: 60px;" srcset=""></a>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item ">
                                <a href="{{route('addAdmin')}}">Create  New Admin</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="{{route('manageAdmin')}}">Mange Admain</a>
                            </li>
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            <li class="submenu-item">
                                <a href="{{route('addCourse')}}">Create New Course</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="{{route('manageCourse')}}">Manage Course</a>
                            </li>
                    ...
                    <li
                        ...
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item ">
                                <a href="">Quize Subject</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="">Quize Topic</a>
                            </li>
                            <li class="submenu-item ">
                                <a href="">Add Quize</a>
                            </li>
